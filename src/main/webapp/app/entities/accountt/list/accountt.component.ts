...
import { EntityArrayResponseType, AccounttService } from '../service/accountt.service';
...
export class AccounttComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAccountt): number => this.accounttService.getAccounttIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.accountts = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IAccountt[] | null): IAccountt[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.accounttService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
