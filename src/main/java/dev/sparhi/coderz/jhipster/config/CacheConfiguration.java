package dev.sparhi.coderz.jhipster.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, dev.sparhi.coderz.jhipster.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, dev.sparhi.coderz.jhipster.repository.UserRepository.USERS_BY_EMAIL_CACHE);
