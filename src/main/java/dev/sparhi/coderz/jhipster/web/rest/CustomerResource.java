...
/**
 * REST controller for managing {@link dev.sparhi.coderz.jhipster.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Customer> partialUpdateCustomer(
        ...
        Optional<Customer> result = customerRepository
            ...
            .map(existingCustomer -> {
                ...
                if (customer.getShortDescription() != null) {
                    existingCustomer.setShortDescription(customer.getShortDescription());
                }
