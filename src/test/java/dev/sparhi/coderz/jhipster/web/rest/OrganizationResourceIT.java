...
class OrganizationResourceIT {
    ...
    private static final Long DEFAULT_ENVIRONMENT = 1L;
    private static final Long UPDATED_ENVIRONMENT = 2L;
    ...
    public static Organization createEntity(EntityManager em) {
        Organization organization = new Organization().name(DEFAULT_NAME).environment(DEFAULT_ENVIRONMENT);
        return organization;
    }
    ...
    public static Organization createUpdatedEntity(EntityManager em) {
        Organization organization = new Organization().name(UPDATED_NAME).environment(UPDATED_ENVIRONMENT);
        return organization;
    }
    ...
    void createOrganization() throws Exception {
        ...
        assertThat(testOrganization.getEnvironment()).isEqualTo(DEFAULT_ENVIRONMENT);
    }
    ...
    void getAllOrganizations() throws Exception {
        ...
        restOrganizationMockMvc
            ...
            .andExpect(jsonPath("$.[*].environment").value(hasItem(DEFAULT_ENVIRONMENT.intValue())));
    }
    ...
    void getOrganization() throws Exception {
        ...
        restOrganizationMockMvc
            ...
            .andExpect(jsonPath("$.environment").value(DEFAULT_ENVIRONMENT.intValue()));
    }
    ...
    void putExistingOrganization() throws Exception {
        ...
        updatedOrganization.name(UPDATED_NAME).environment(UPDATED_ENVIRONMENT);
        ...
        assertThat(testOrganization.getEnvironment()).isEqualTo(UPDATED_ENVIRONMENT);
    }
    ...
    void fullUpdateOrganizationWithPatch() throws Exception {
        ...
        partialUpdatedOrganization.name(UPDATED_NAME).environment(UPDATED_ENVIRONMENT);
