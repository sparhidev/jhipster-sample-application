...
import dev.sparhi.coderz.jhipster.domain.Customer;
import dev.sparhi.coderz.jhipster.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).shortDescription(DEFAULT_SHORT_DESCRIPTION);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).shortDescription(UPDATED_SHORT_DESCRIPTION);
        return customer;
    }
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getShortDescription()).isEqualTo(DEFAULT_SHORT_DESCRIPTION);
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).shortDescription(UPDATED_SHORT_DESCRIPTION);
        ...
        assertThat(testCustomer.getShortDescription()).isEqualTo(UPDATED_SHORT_DESCRIPTION);
    }
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).shortDescription(UPDATED_SHORT_DESCRIPTION);
